...
class Checkout {
	...
	/**
	 * Process form fields during the WooCommerce checkout.
	 *
	 * This function verifies the nonce for security, checks if the terms and conditions are agreed,
	...
	public function processFields() {
		...
		if ( ! isset( $_POST['agree_term_condition_opp'] ) && isset( $_POST['payment_method'] ) && $_POST['payment_method'] === Helper::getGatewayId() ) {
